...
class CRMUploaderFormComponent extends React.Component<ICRMUploaderFormComponent, {}> {
    ...
    componentDidMount() {
        console.log(" populateCRMListTable called componentDidMount");
        // window.scrollTo(0, 0)
        this.fileDetail = { name: "", size: 0 };
    ...
    componentDidUpdate() {
        console.log(" populateCRMListTable called componentDidUpdate");
        ...
        console.log("this.props.crmItemList==>", this.props.crmItemList);   
    }
...
export default connect(mapStateToProps, (dispatch) => {
    return {
        ...
        initCRMList(selectedItem: any) {
            console.log("populateCRMListTable => Inside initCRMList");
