...
export const sendDashboardGenderStateAction = createAction<any>(
  ActionConstants.DashboardGenderState
);
...
export const deleteQuerySegments = createAction<any>(
  ActionConstants.QUERYSEGMENTIDDELETE
);
...
/*Report */
export const submitRequestAction = createAction<any>(
  ActionConstants.SUBMIT_REQUESTS
);
export const listAllRequestAction = createAction<any>(
  ActionConstants.LISTALL_REQUESTS
);
export const populateRequestsData = createAction<any>(
  ActionConstants.SHOWALL_REQUESTS
);
export const RequestsStatusDalAction = createAction<any>(
  ActionConstants.DAL_REQUESTS
);
export const showIndividualRequestsAction = createAction<any>(
  ActionConstants.IND_REQUESTS
);
export const submitUpdateRequestAction = createAction<any>(
  ActionConstants.UPDATE_REQUESTS
);
export const downloadRequestFileAction = createAction<any>(
  ActionConstants.DOWNLOAD_REQUEST
);
export const RequestsUpdateInPrgAction = createAction<any>(
  ActionConstants.DUMMY_UPDATE
);

export const sendRoleBasedConfiguration = createAction<any>(
  ActionConstants.ROLECONFIG
);
export const listAllRequestersAction = createAction<any>(
  ActionConstants.REQUESTERSRECENT_REQUESTS
);

export const listAllRecentRequestAction = createAction<any>(
  ActionConstants.LISTALL_REQUESTERSRECENT_REQUESTS
);